            ...
            <div class="card-body mt-5 mb-5">
               ...
               <form action="" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-md-8">
                        <input id="address" type="text" value="<?php echo $result['address']; ?>" class="form-control"
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-md-8">
                        <textarea name="information" id="information" class="form-control" cols="4"
                           rows="4"> <?php echo $result['information']; ?></textarea>
